...
export function Role({ role, children }: RoleProps) {
  let badgeClasses = "";
  if (role === "worker")
    badgeClasses = "bg-orange-100 text-orange-500 ring-orange-500";
  if (role === "client")
    badgeClasses = "bg-blue-100 text-blue-500 ring-blue-500";
  if (role === "business")
    badgeClasses = "bg-pink-100 text-pink-500 ring-pink-500";
